...
class Tank_auth
{
	 ...
	 * @return	array
	 */
	function create_user($username, $email, $password, $email_activation, $subdomain)
	{
    ...
    } elseif (!$this->ci->users->is_subdomain_available($subdomain)) {
      $this->error = array('email' => 'auth_subdomain_in_use');
